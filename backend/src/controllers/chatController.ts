...
import { SupportedModelId, SUPPORTED_MODELS } from "../services/chatService";

export const handleChatMessage = async (req: Request, res: Response) => {
  try {
    const { message, role, sessionId, modelId } = req.body;
    ...
    const resolvedModelId: SupportedModelId = validModelIds.includes(modelId)
